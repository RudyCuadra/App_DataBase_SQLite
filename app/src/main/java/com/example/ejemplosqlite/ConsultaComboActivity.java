...
public class ConsultaComboActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comboPersonas = findViewById(R.id.esOpcion);

        txtNombre = findViewById(R.id.txtNombreCombo);
        txtDocumento = findViewById(R.id.txtDocumentoCombo);
        txtTelefono = findViewById(R.id.txtTelefonoCombo);
